...
let flippedCards = []; // more specified HTMLArticleElement
let isFlipped = false;
...
function flipCard() {
    if (isFlipped || this.classList.contains('flip') || flippedCards.length === 2)
        return;
...
function showOverlay() {
    ...
    overlay.classList.add('show'); // tells TypeScript to treat overlay as an HTMLElement and not consider the possibility of it being null
}
